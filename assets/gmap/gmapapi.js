...
(function () {
    ...
    function getScript(src) {
        document.write('<' + 'script src="'+base_url+'/e-maps/assets/gmap/' + src + '"' + ' type="text/javascript"><' + '/script>');
    }
    ...
    google.maps.Load = function (apiLoad) {
        ...
        apiLoad([null, [
            ...
            null,
            null,
            base_url+"/e-maps/assets/gmap/gmapcache/gstatic/",
            "http://csi.gstatic.com",
            "https://maps.googleapis.com",
            base_url+"/e-maps/assets/gmap/gmapcache/googleapis",
        ], [
